  ...
  return (
    <div className="flex flex-col h-max bg-gray-900 lg:flex-row min-h-screen">
      ...
      <div className="flex-1 p-4 h-max lg:p-10 justify-center items-center">
        ...
        <p className="text-blue-300">🔥 Your EchoLink is live: <a href={`https://linktree-frontend-tyj0.onrender.com//user/${currentUser?.name}`} className="underline">{`${CALLBACK_URL}/user/${currentUser?.name}`}</a></p>
        </div>
